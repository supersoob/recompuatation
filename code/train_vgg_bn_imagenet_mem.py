...
from memonger import vgg_bn_imagenet as get_vgg_bn
...
def plot_mem(
    ...
    df.to_excel(f"vgg_bn_imgnet_memory_{sys.argv[1]}.xlsx")
...
plot_mem(df, exps=['vgg_bn'], output_file=f'./vgg_bn_imgnet_mem_{bs}.png')
